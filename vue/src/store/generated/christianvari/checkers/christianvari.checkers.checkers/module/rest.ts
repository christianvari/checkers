...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/christianvari/checkers/checkers/can_play_move/{idValue}/{player}/{fromX}/{fromY}/{toX}/{toY}
   */
  queryCanPlayMove = (
    idValue: string,
    player: string,
    ...
    this.request<CheckersQueryCanPlayMoveResponse, RpcStatus>({
      path: `/christianvari/checkers/checkers/can_play_move/${idValue}/${player}/${fromX}/${fromY}/${toX}/${toY}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/christianvari/checkers/checkers/next_game
   */
  queryNextGame = (params: RequestParams = {}) =>
    this.request<CheckersQueryGetNextGameResponse, RpcStatus>({
      path: `/christianvari/checkers/checkers/next_game`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/christianvari/checkers/checkers/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<CheckersQueryParamsResponse, RpcStatus>({
      path: `/christianvari/checkers/checkers/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/christianvari/checkers/checkers/stored_game
   */
  queryStoredGameAll = (
    query?: {
    ...
    this.request<CheckersQueryAllStoredGameResponse, RpcStatus>({
      path: `/christianvari/checkers/checkers/stored_game`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/christianvari/checkers/checkers/stored_game/{index}
   */
  queryStoredGame = (index: string, params: RequestParams = {}) =>
    this.request<CheckersQueryGetStoredGameResponse, RpcStatus>({
      path: `/christianvari/checkers/checkers/stored_game/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
